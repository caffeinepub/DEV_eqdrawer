import { c as createLucideIcon, r as reactExports, u as useLayoutEffect2, R as React, a as useCallbackRef$1, b as useComposedRefs, j as jsxRuntimeExports, P as Primitive, d as composeEventHandlers, e as dispatchDiscreteCustomEvent, f as ReactDOM, g as createContext2, h as Presence, i as createContextScope, k as createSlot, l as createSlottable, m as cn, n as buttonVariants, o as useInternetIdentity, p as useNavigate, q as useEquations, s as useCreateEquation, t as useDeleteEquation, B as Button, v as Plus, S as SquareFunction, L as LogIn, w as Skeleton, T as Trash2 } from "./index-dkC_vG9A.js";
import { I as Input, d as drawGrid, p as parseExplicit, a as drawExplicit, i as isImplicit, b as drawImplicit, c as buildImplicit, E as EQUATION_COLORS } from "./canvasUtils-Bt--7fPj.js";
/**
...
function EquationThumbnail({ canvasData }) {
  const ref = reactExports.useRef(null);
  reactExports.useEffect(() => {
  ...
  if (!hasEntries) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SquareFunction, { className: "w-10 h-10 text-muted-foreground/30" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "canvas",
    {
...
function EquationCard({ eq, onDelete }) {
  const navigate = useNavigate();
  const updatedDate = new Date(
    Number(eq.updatedAt) / 1e6
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-video bg-muted/60 flex items-center justify-center border-b border-border overflow-hidden relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(EquationThumbnail, { canvasData: eq.canvasData }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate leading-tight", children: eq.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: updatedDate })
        ] })
      ]
    }
  );
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs", children: "Type 2D equations, save them, and access from any device." })
        ] }),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Try a different name." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", onClick: onClear, children: "Clear search" })
      ]
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-sm", children: "Type and visualize 2D equations. Sign in to save and resume from any device." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
...
function LibraryPage() {
  ...
  const filtered = (equations ?? []).filter(
    (eq) => eq.name.toLowerCase().includes(search.toLowerCase())
  );
  if (!isLoggedIn) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(LoginGate, { onLogin: login });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-screen-2xl mx-auto", "data-ocid": "library-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-3 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold text-foreground flex-1", children: "My Equations" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full sm:w-64", "data-ocid": "library-search", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingGrid, {}) : (equations ?? []).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyLibrary, { onNew: handleNew, isCreating: createEquation.isPending }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(NoResults, { query: search, onClear: () => setSearch("") }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4",
        "data-ocid": "library-grid",
        children: filtered.map((eq) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          EquationCard,
          {
            eq,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "library-delete-dialog", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete equation?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: toDelete == null ? void 0 : toDelete.name }),
              " will be permanently deleted. This cannot be undone."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "library-delete-cancel", children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              AlertDialogAction,
              {
